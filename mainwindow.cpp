    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->label_41->setPixmap(QPixmap(":/logo/logooooo-removebg-preview.png"));
    // Appliquer un fond dégradé bleu très clair vers gris clair à la page d'accueil (index 1)
    QWidget* pageAccueil = ui->stackedWidget->widget(1);
    pageAccueil->setStyleSheet("background: qlineargradient(x1:0, y1:0, x2:1, y2:1, "
                               "stop:0 #eaf0f6, stop:1 #d9dee3);");
         ...
         //showpage6
           ...
           //retour
            ...
            //stat client
               ...
               //tache
                connect(ui-> pushButton_20, &QPushButton::clicked, this, &MainWindow:: showpagetache);
                 connect(ui-> pushButton_52, &QPushButton::clicked, this, &MainWindow:: showpagehome);
                  connect(ui->pushButton_46, &QPushButton::clicked, this, &MainWindow::ajouter_tache);
                 connect(ui->pushButton_43, &QPushButton::clicked, this, &MainWindow::modifier_tache);
                   connect(ui->pushButton_44, &QPushButton::clicked, this, &MainWindow::supprimer_tache);
                    connect(ui->pushButton_recherche, &QPushButton::clicked, this, &MainWindow::rechercher_tache);
                     connect(ui->buttonTrier_3, &QPushButton::clicked, this, &MainWindow::tri_tache);
                      connect(ui->pushButton_statistiques_3, &QPushButton::clicked, this, &MainWindow::stat_tache);
                       connect(ui->pushButton_pdf_3, &QPushButton::clicked, this, &MainWindow::pdf_tache);

                    connect(ui->pushButton_47, &QPushButton::clicked, this, &MainWindow::loadTachesNotifications);
...
//page 8
void MainWindow::showpagetache()
{
    // Changer pour la page 2 (index 8)
    ui->stackedWidget->setCurrentIndex(8);
}
void MainWindow::showpagehome()
{
    // Changer pour la page 2 (index 1)
    ui->stackedWidget->setCurrentIndex(1);
}
...
void MainWindow::afficherTaches()
{
    ...
    int row = 0;
    ui->tableWidget_3->setRowCount(0); // Réinitialiser la table
    ...
    while (query.next()) {
        ...
        for (int col = 0; col < 6; ++col) {
            ui->tableWidget_3->setItem(row, col, new QTableWidgetItem(query.value(col).toString()));
        }
        row++;
    }
...
void MainWindow::setupCalendar()
{
    ...
    calendarLayout->addWidget(ui->calendarWidget);
...
void MainWindow::modifier_tache() {
    int id = ui->lineEditID->text().toInt();
    QString nom = ui->lineEditNom->text();
    QString description = ui->lineEditDescription->text();
    int consultant = ui->lineEditConsultant->text().toInt();
...
void MainWindow::supprimer_tache() {
    int id = ui->lineEditID->text().toInt();
...
void MainWindow::rechercher_tache()
{
